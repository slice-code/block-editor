 ...
 * Supports Twitter/X, Instagram, TikTok, Spotify, SoundCloud, Vimeo, Google Maps
 */
...
class EmbedBlock {
  ...
  renderInput() {
    ...
    this.input.type = 'url';
    this.input.placeholder = 'Paste a link (Twitter, Instagram, TikTok, Spotify, YouTube, etc.)';
  ...
  handleUrlInput(url) {
    ...
    if (!service) {
      alert('Unsupported URL. Please use Twitter, Instagram, TikTok, Spotify, SoundCloud, YouTube, Vimeo, or Google Maps.');
      return;
    }
