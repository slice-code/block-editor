...
const editor = async ({el, onClose, onSave, categories = [], type = 'newsletter', storage = { type: 'indexedDB' }, initialData = null, enableDraft = true}) => {
  ...
  categoryOptions.forEach(cat => {
    categorySelect.child(el('option').value(cat.value).text(cat.text));
  });
